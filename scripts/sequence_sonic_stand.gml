...
else if (sequence_position(200))
{
    image_index = 0;
}
else if (sequence_position(206))
{
    image_index = 5;
}
else if (sequence_position(212))
{
    image_index = 6;
}
else if (sequence_position(218))
{
    image_index = 7;
}
else if (sequence_position(223))
{
    sequence_moment = 0;
}
