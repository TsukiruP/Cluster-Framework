...
// Wait:
player_add_animation(CHAR_SONIC, "wait_short",     spr_sonic_wait_short,     0, 22,  0,  0, 0.18, "stand");
player_add_animation(CHAR_SONIC, "wait_long",      spr_sonic_wait_long,      0, 21, 18, -1, 0.10);
...
player_add_animation(CHAR_SONIC, "super_spin",     spr_sonic_super_spin,     0,  3,  0,  0, 0.30);
...
// Tag jump:
player_add_animation(CHAR_SONIC, "tag_flight",     spr_sonic_tag_jump,       0,  2,  0, -1, 0.20);
player_add_animation(CHAR_SONIC, "tag_fall",       spr_sonic_tag_jump,       3, 11,  9, -1, 0.20);
