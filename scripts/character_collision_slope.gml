/// character_collision_slope(x, y, angle, mask)
...
// Collision test:
collision_test = character_collision(floor(argument0 + dsin(argument2) * 23), floor(argument1 + dcos(argument2) * 23), collision_layer);
