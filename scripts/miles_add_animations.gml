...
// Tag default:
character_add_animation(CHAR_MILES, "tag_stand",      spr_miles_tag_stand,        0,  3,  0, -1, 0.20);
...
character_add_animation(CHAR_MILES, "tag_look_end",   spr_miles_tag_look,        11, 13,  0,  0, 0.20, "tag_stand");

// Crouch:
character_add_animation(CHAR_MILES, "crouch",         spr_miles_crouch,           0, 17,  2, -1, 0.20);
character_add_animation(CHAR_MILES, "crouch_end",     spr_miles_crouch,          18, 19,  0,  0, 0.20, "stand");

// Tag crouch:
character_add_animation(CHAR_MILES, "tag_crouch",     spr_miles_tag_crouch,       0, 18,  3, -1, 0.20);
character_add_animation(CHAR_MILES, "tag_crouch_end", spr_miles_tag_crouch,      19, 22,  0,  0, 0.20, "tag_stand");
...
// Ready:
character_add_animation(CHAR_MILES, "ready",          spr_miles_ready,            0, 30,  0,  0, 0.18, "stand");
