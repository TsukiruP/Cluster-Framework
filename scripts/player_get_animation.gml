...
// Sets animation data based on the current animation, or returns specific information about the given information.
...
if(global.animation_grid != -1) {
    if(global.animation_initialized = true) {
        ...
        if(argument_count >= 2) {
            ...
            return ds_grid_get(global.animation_grid, argument[1], animation_range);
        } else {
