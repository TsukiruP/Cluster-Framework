...
else if (sequence_position(22)) image_index = 6;
else if (sequence_position(27)) image_index = 7;
else if (sequence_position(32)) image_index = 8;
else if (sequence_position(38)) image_index = 9;
else if (sequence_position(44)) instance_destroy();
