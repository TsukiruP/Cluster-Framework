/// character_collision_left_edge(x, y, angle)
...
// Collision test:
collision_test = character_collision(floor(argument0 - dcos(argument2) * 8 + dsin(argument2) * 11), floor(argument1 + dsin(argument2) * 11 + dcos(argument2) * 11), collision_layer);
