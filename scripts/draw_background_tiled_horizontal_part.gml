/// draw_background_tiled_horizontal_part(back, left, top, width, height, x, y, sep)
...
repeat((background_end - background_start) / background_step) {
    draw_background_part(argument0, argument1, argument2, argument3, argument4, background_start, argument6);
