/// character_collision_right(x, y, angle, mask)
...
// Collision test:
collision_test = character_collision(floor(argument0 + dcos(argument2) * 11), floor(argument1 - dsin(argument2) * 11), collision_layer);
