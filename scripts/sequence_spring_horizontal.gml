...
{
    image_index = 1;
    hitbox_set_hurtbox(16, 5, 2, 5);
}
else if (sequence_position(2))
{
    image_index = 2;
    hitbox_set_hurtbox(16, 5, 17, 5);
}
else if (sequence_position(6))
{
    image_index = 3;
    hitbox_set_hurtbox(16, 5, 13, 5);
}
else if (sequence_position(8))
{
    image_index = 4;
    hitbox_set_hurtbox(16, 5, 16, 5);
}
...
else if (sequence_position(14))
{
    ...
    sequence_set(sequence_spring_horizontal);
}
