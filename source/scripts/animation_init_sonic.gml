...
// Default:
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "stand", seq_sonic_stand);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "cliff_front", seq_sonic_cliff_front);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "cliff_back", seq_sonic_cliff_back);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "wait_leader", seq_sonic_wait_leader);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "wait_partner", seq_sonic_wait_partner);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "standby", seq_sonic_standby);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "land", seq_sonic_land);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "omochao", seq_sonic_omochao);
...
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "crouch_end", seq_sonic_crouch_end);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "spin_dash", seq_sonic_spin_dash);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "spin_charge", seq_sonic_spin_charge);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "roll", seq_sonic_roll);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "spin_flight", seq_sonic_spin_flight);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "spin_fall", seq_sonic_spin_fall);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "brake", seq_sonic_brake);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "brake_fast", seq_sonic_brake_fast);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "hurt", seq_sonic_hurt);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "death", seq_sonic_death);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "push", seq_sonic_push);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "ramp_flight", seq_sonic_ramp_flight);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "ramp_fall", seq_sonic_ramp_fall);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "spring_flight", seq_sonic_spring_flight);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "spring_fall", seq_sonic_spring_fall);
...
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "skid", seq_sonic_skid);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "skid_end", seq_sonic_skid_end);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "insta", seq_sonic_insta);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "air_dash", seq_sonic_air_dash);
...
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "leap_frog", seq_sonic_leap_frog);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "leap_flight", seq_sonic_leap_flight);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_DEFAULT, "leap_fall", seq_sonic_leap_fall);
...
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_TAG, "crouch_end", seq_sonic_tag_crouch_end);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_TAG, "brake", seq_sonic_tag_brake);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_TAG, "spring_flight", seq_sonic_tag_spring_flight);
animation_set(CHAR_SONIC, FORM_BASE, VARIANT_TAG, "spring_fall", seq_sonic_tag_spring_fall);
