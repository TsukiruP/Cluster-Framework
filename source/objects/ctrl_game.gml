...
game_room_add(rm_basic_test_1, TRANS_CARD, "bgm_basic_test_1", obj_zone_map_parallax, "Basic Test", 1, 1056, START_STANDBY);
game_room_add(rm_basic_test_2, TRANS_CARD, "bgm_basic_test_1", obj_zone_map_parallax, "Basic Test", 2, 720);
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
applies_to=self
...
var game_string; game_string = GAME_NAME + " v" + string_format(GAME_VERSION, 1, 2);
