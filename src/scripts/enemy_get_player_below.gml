...
var player_inst; player_inst = instance_nearest_dir_y(x, y, obj_player, image_xscale, _range);;
...
if (instance_exists(player_inst))
{
    ...
    if (sign(image_yscale) == sign(y - player_inst.y) || instance_exists(player_solid) || player_inst.state_current == player_state_death) player_inst = noone;
