...
var player_inst; player_inst = instance_nearest_dir_y(x, y, obj_player, image_yscale);
...
if (instance_exists(player_inst))
{
    ...
    if (instance_exists(player_solid) || player_distance >= _range || player_inst.state_current == player_state_death) player_inst = noone;
