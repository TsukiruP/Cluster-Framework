...
trick_x_speed[CHAR_KNUX, TRICK_UP] = 0;
trick_y_speed[CHAR_KNUX, TRICK_UP] = -6;
trick_x_speed[CHAR_KNUX, TRICK_DOWN] = 0;
trick_y_speed[CHAR_KNUX, TRICK_DOWN] = 1;
trick_x_speed[CHAR_KNUX, TRICK_FRONT] = 6;
trick_y_speed[CHAR_KNUX, TRICK_FRONT] = 0;
trick_x_speed[CHAR_KNUX, TRICK_BACK] = -5;
trick_y_speed[CHAR_KNUX, TRICK_BACK] = 0;
