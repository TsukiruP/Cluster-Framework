...
animation_set(CHAR_MILES, FORM_BASE, VARIANT_DEFAULT, "look", seq_sonic_look);
animation_set(CHAR_MILES, FORM_BASE, VARIANT_DEFAULT, "look_end", seq_sonic_look_end);
animation_set(CHAR_MILES, FORM_BASE, VARIANT_DEFAULT, "crouch", seq_sonic_crouch);
