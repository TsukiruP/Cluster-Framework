...
else if (sequence_position(4)) image_index = 7;
...
else if (sequence_position(34)) image_index = 13;
else if (sequence_position(40)) image_index = 14;
else if (sequence_position(46)) image_index = 15;
else if (sequence_position(51)) sequence_moment = 16;