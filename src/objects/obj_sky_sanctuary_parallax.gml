...
cloud_x[0] = -mod_time(game_get_time(), 7, background_get_width(bg_sky_sanctuary_2));
cloud_x[1] = -mod_time(game_get_time(), 6, background_get_width(bg_sky_sanctuary_3));
cloud_x[2] = -mod_time(game_get_time(), 5, background_get_width(bg_sky_sanctuary_4));
cloud_x[3] = -mod_time(game_get_time(), 3, background_get_width(bg_sky_sanctuary_5));
cloud_x[4] = -mod_time(game_get_time(), 6, background_get_width(bg_sky_sanctuary_6));
cloud_x[5] = -mod_time(game_get_time(), 5, background_get_width(bg_sky_sanctuary_7));
cloud_x[6] = -mod_time(game_get_time(), 4, background_get_width(bg_sky_sanctuary_8));
cloud_x[7] = -mod_time(game_get_time(), 2, background_get_width(bg_sky_sanctuary_9));
#define Draw_0
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
