...
if ((sequence_index == seq_buzzer_aim || sequence_index == seq_buzzer_move) && buzzer_alarm > 0) buzzer_alarm = roundto_step(buzzer_alarm, -sequence_speed);
#define Step_2
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
...
// Initiate shoot:
if ((sequence_index == seq_buzzer_aim || sequence_index == seq_buzzer_move) && buzzer_alarm == 0)
{
    player_inst = instance_nearest(x, y, obj_player);
